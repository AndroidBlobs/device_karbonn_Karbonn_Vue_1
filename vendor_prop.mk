PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.config.alarm_alert=FANTASIA.wav \
    ro.config.default_message0=DECISO.wav \
    ro.config.default_message1=DECISO.wav \
    ro.config.default_message=DECISO.wav \
    ro.config.low_ram=true \
    ro.config.notification_sound=FACILE.wav \
    ro.config.ringtone0=CAVATINA.wav \
    ro.config.ringtone1=JOYEUX.wav \
    ro.config.ringtone=CAVATINA.wav \
